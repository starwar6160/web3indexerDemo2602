    ...
    try {
        ...
        try {
            await db.schema
                ...
                .addColumn('last_synced_at', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
                .addColumn('sync_status', 'varchar(20)', (col) => col.notNull().defaultTo('syncing')) // 'syncing', 'caught_up', 'error'
