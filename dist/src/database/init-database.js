...
async function initDatabase() {
    ...
    try {
        ...
        try {
            ...
            await db.schema
                .createTable('blocks')
                .addColumn('number', 'bigint', (col) => col.notNull().primaryKey())
        ...
        try {
            await db.schema
                ...
                .addColumn('value', (0, kysely_1.sql) `decimal(78,18)`) // Phase 4: DECIMAL for token amounts
                .addColumn('gas_price', (0, kysely_1.sql) `decimal(78,18)`)
        ...
        try {
            await db.schema
                ...
                .addColumn('status', 'varchar(20)', (col) => col.notNull().defaultTo('active')) // active, paused, error, complete
        ...
        try {
            await db.schema
                ...
                .addColumn('timestamp', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
                .addColumn('created_at', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
                .execute();
