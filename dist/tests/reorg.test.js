...
vitest_1.describe.skip('Reorg Tests', () => {
    ...
    (0, vitest_1.it)('should detect and handle reorg', async () => {
        console.log('\n=== Test 1: Simple Reorg Detection ===');
        const repo = new block_repository_1.BlockRepository();
        try {
            // Insert initial blocks 0-9
            ...
            const reorgDetected = await (0, reorg_handler_1.detectReorg)(repo, 5);
            (0, vitest_1.expect)(reorgDetected).toBe(true);
