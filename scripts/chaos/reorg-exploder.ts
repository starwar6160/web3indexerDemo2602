...
async function main() {
  ...
  try {
    ...
    // 💰 DEPOSIT: Get SimpleBank internal balance by depositing ETH
    console.log('\n💰 Depositing 10 ETH to get SimpleBank internal balance...');
    ...
    console.log(`✅ Deposited 10 ETH, received internal balance\n`);
