...
const ACCOUNT_1 = privateKeyToAccount(PRIVATE_KEYS[0]);
const ACCOUNT_2 = privateKeyToAccount(PRIVATE_KEYS[1]);
const ACCOUNT_3 = privateKeyToAccount(PRIVATE_KEYS[2]);
